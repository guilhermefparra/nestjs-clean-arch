...
export class SearchResult<E extends Entity, Filter = string> {
  ...
  toJSON(forceEntity = false): SearchResult<E, Filter> {
    return {
      items: forceEntity ? this.items.map(it => it.toJSON()) : this.items,
      total: this.total,
